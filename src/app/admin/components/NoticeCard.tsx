              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem>
                  <Link
                    ...
                    href={`/admin/content/${notice.noticeURL.substring(
                      notice.noticeURL.lastIndexOf("/") + 1
                    )}`}
                  >
                ...
                <DropdownMenuItem>
                  <Link
                    className="flex justify-center items-center "
                    href={`/admin/content/update/${notice.id}`}
                  >
                ...
                <AlertDialogDescription>
                  <div className=" flex flex-col space-y-5 mt-6">
                    <div>
                      ...
                      <Input
                        id="name"
                        defaultValue={notice.admin.firstName}
